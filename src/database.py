...
def init_db():
    ...
    default_configs = [
        ...
        # Budget guard for autonomous epistemic ingestion (issue #74): phases 2-3
        # cost an LLM call per fact. Not agent-modifiable so the swarm cannot
        # raise its own spending cap. 0 disables ingestion.
